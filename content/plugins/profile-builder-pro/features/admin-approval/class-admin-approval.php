...
class wpp_list_approved_unapproved_users extends PB_WP_List_Table {
		...
		if (current_user_can('delete_users')){
			...
			if( 'approved'===$this->current_action() ) {
				...
				<script type="text/javascript">
					confirmAUActionBulk('<?php echo get_bloginfo('wpurl').'/wp-admin/users.php?page=admin_approval'.$extra_args;?>', '<?php _e("Do you want to bulk approve the selected users?", "profile-builder");?>', '<?php echo $wppb_nonce;?>', '<?php echo $users;?>', 'bulkApprove');
				</script>
				<?php
				...
				?>
				<script type="text/javascript">
					confirmAUActionBulk('<?php echo get_bloginfo('wpurl').'/wp-admin/users.php?page=admin_approval'.$extra_args;?>', '<?php _e("Do you want to bulk unapprove the selected users?", "profile-builder");?>', '<?php echo $wppb_nonce;?>', '<?php echo $users;?>', 'bulkUnapprove');
				</script>
				<?php
			}elseif( 'delete'===$this->current_action() ) {
				?>
				<script type="text/javascript">
					confirmAUActionBulk('<?php echo get_bloginfo('wpurl').'/wp-admin/users.php?page=admin_approval'.$extra_args;?>', '<?php _e("Do you want to bulk delete the selected users?", "profile-builder");?>', '<?php echo $wppb_nonce;?>', '<?php echo $users;?>', 'bulkDelete');
				</script>
				<?php
			}
    ...
    function prepare_items() {
        ...
        foreach( $queried_users as $user ){
            ...
            /* get user status */
            if ( !wp_get_object_terms( $user->ID, 'user_status' ) )
                $status = __( 'Approved', 'profile-builder' );
            else
                $status = __( 'Unapproved', 'profile-builder' );
