...
function wppb_cr_replace_tags( $redirect_url, $wppb_cr_username = NULL ) {
	$wppb_cr_tags = apply_filters( 'wppb_cr_tags', array(
		...
		'{{http_referer}}' => ( isset( $_POST['wppb_referer_url'] ) ? $_POST['wppb_referer_url'] : NULL ),
	) );
